...
/* harmony import */ var _components_common_listGroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/common/listGroup */ "./src/components/common/listGroup.jsx");
/* harmony import */ var _components_postsTable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/postsTable */ "./src/components/postsTable.jsx");
/* harmony import */ var _components_common_pagination__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/common/pagination */ "./src/components/common/pagination.jsx");
/* harmony import */ var _utils_paginate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/paginate */ "./src/utils/paginate.js");
...
function AuthorPostTable(props) {
  ...
  const [sortColumn, setSortColumn] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)({
  ...
  if (searchQuery) {
    filtered = allPosts?.filter(post => post.title.rendered.toLowerCase().startsWith(searchQuery.toLowerCase()));
  } else if (selectedCat) {
    filtered = allPosts?.filter(post => post.categories.includes(selectedCat.id));
  }
  const sorted = lodash__WEBPACK_IMPORTED_MODULE_2___default().orderBy(filtered, [sortColumn.column], [sortColumn.order]);
  const userPosts = (0,_utils_paginate__WEBPACK_IMPORTED_MODULE_7__.paginate)(sorted, currentPage, pageItems);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    class: "col-3"
  }, loaded && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_common_listGroup__WEBPACK_IMPORTED_MODULE_4__["default"], {
    items: catsObj,
    selectedItem: selectedCat,
    onItemSelect: handleCatSelect
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "col"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToastContainer, {
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_postsTable__WEBPACK_IMPORTED_MODULE_5__["default"], {
    items: userPosts,
    itemsCount: countPosts,
    itemsLoaded: loaded,
    sortColumn: sortColumn,
    onSort: handleSort
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_common_pagination__WEBPACK_IMPORTED_MODULE_6__["default"], {
